...
// Emoji fonts (apps fork): used by DiceActivity (48pt) and ChessActivity (16pt).
#define NOTOSANS_48_EMOJI_FONT_ID (-1559376469)
#define NOTOSANS_16_EMOJI_FONT_ID (117354205)
...
static_assert(NOTOSANS_48_EMOJI_FONT_ID != 0, "Font ID collision with sentinel");
static_assert(NOTOSANS_16_EMOJI_FONT_ID != 0, "Font ID collision with sentinel");
